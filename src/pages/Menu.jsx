                                ...
                                >
                                    ...
                                    {popupItem === item && (
                                        <div className="menu-item-popup" onClick={e => e.stopPropagation()}>
                                            <img src={import.meta.env.BASE_URL + item.img} alt={item.name} className="menu-popup-img" />
                                            <div className="menu-popup-info">
                                                <div className="menu-popup-ingredients">{item.nutrition.ingredients}
                                                </div>
                                                <div className="menu-popup-calories">{item.nutrition.calories} kcal
                                                </div>
                                            </div>
                                        </div>
                                    )}
