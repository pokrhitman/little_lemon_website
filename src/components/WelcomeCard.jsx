  ...
  return (
    ...
    >
      <View style={GlobalStyles.welcomeHeader}>
        ...
        />
        <Text style={[GlobalStyles.welcomeTitle, { color: isLight ? '#000000' : '#FFFFFF' }]}>
      ...
      <Text style={[GlobalStyles.welcomeSubtitle, { color: isLight ? '#333' : '#EDEFEE' }]}>
        ...
        in a lively but casual environment. We would love to hear more about your experience with
        us!
      </Text>
    </ScrollView>
  );
